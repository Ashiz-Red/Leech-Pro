...
class Config:
    ...
    TG_BOT_TOKEN = get_config("TG_BOT_TOKEN", "1710514865:AAGaBcYHJyDb1COYVvZipy7kNKcb1hT65iE")
    # The Telegram API things
    APP_ID = int(get_config("APP_ID", "5924779"))
    API_HASH = get_config("API_HASH", "619fcd44335b53c5f809df6e4695d4d2
")
    ...
    DEF_THUMB_NAIL_VID_S = get_config(
        ...
        "https://telegra.ph/file/b5a3ee776e8b27e60c9f0.jpg"
    )
